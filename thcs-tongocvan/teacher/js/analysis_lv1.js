...
let linkBackToLogInPage = "https://luyenthi-ic3.github.io/thcs-tongocvan/teacher";
let data1 = [];
let listUnitLT = [];
let listUnitTT = [];
...
function renderDataResultSearch(){
  ...
  var qu_AllData = 'Select B, C, D, E, F, G, H, I WHERE F = \"' + unitSelected + '\" AND E = \"' + classSelected + '\"';
  var queryAllData = encodeURIComponent(qu_AllData);
  var urlAllData = `${base}&sheet=${sheetName}&tq=${queryAllData}`;
  fetch(urlAllData)
  .then(res => res.text())
